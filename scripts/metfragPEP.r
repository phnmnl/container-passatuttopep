...
metfragRes<-read.table(input,sep = "\t" ,comment.char = "",header = T,quote="")
CompoundNameCol<-""
...
passatuttoPath<-
"java -cp \"/usr/local/bin/Passatutto/lib/*\" QValueEstimator -target TARGETFILE -out OUTPUTFILE -method EBA"
